...
"Code completion for C-family, Python, C#, Go, Java and Ruby, Javascript
NeoBundle 'Valloric/YouCompleteMe'
"Omnicompletion for C# (hooks to Youcompleteme)
...
"Autocmd
autocmd BufNewFile,BufReadPost *.wiki setlocal filetype=pandoc
...
let g:syntastic_cs_checkers = ['mcs', 'syntax', 'semantic']
...
"}}}
"Vimwiki {{{
"let g:vimwiki_list = [{'path': '~/vimwiki/', 'path_html': '~/vimwiki_html/', 'ext': '.md'}]
"}}}
" <UNUSED> NerdTree {{{
